...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryByCidTypePage(@RequestParam("cid")Long catelogId,@RequestParam(value = "type",required = false)Integer attrType,QueryCondition condition){
        PageVo pagevo = attrService.queryByCidTypePage(catelogId, attrType, condition);
