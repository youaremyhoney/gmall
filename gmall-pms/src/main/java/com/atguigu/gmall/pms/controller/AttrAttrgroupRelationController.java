...
public class AttrAttrgroupRelationController {
    ...
    public Resp<String> deleteRelatios(@RequestBody List<AttrAttrgroupRelationEntity> attrAttrgroupRelationEntities){
        attrAttrgroupRelationService.deleteRelatios(attrAttrgroupRelationEntities);
        return Resp.ok("删除成功");
    }
